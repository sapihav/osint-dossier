...
| `tvly` | Search / retrieval (official Tavily CLI; binary is `tvly`) | `TAVILY_API_KEY` | `pipx install tavily-cli==0.1.2` |
...
**At least one search provider** (perplexity / exa / tvly / parallel-cli / jina) is
