...
## Gaps
- Subject's current role and organisation. — Try: Look on LinkedIn (/in/schen); cross-check via company press release, filings, or official site. (already attempted: L1).
- At least 2 public platforms with a profile (proof of digital footprint). — Not yet attempted. Try: Search Sam Chen across LinkedIn, Twitter/X, Instagram, GitHub, personal site — surface ≥2 distinct profiles.
- At least one public contact method (email, public DM handle, official form). — Tried L1, L3 — no public source produced a match. Spending more here is probably wasted; treat as a residual gap.
